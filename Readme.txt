...
(Please run the code once before you start using using the passward manger or else the key in the text file will be replaced and you will not be able to decrypt your previously saved password if any.)
